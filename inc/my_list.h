 ...
 *
 * This is a doubly linked list, instead of a bidirectional cyclic linked list.
 *
 * @constructor
 *  @para 1 type size
 */
...
typedef struct LIST_BASE_T
{
     ...
     *
     */
    void (*insert_range)(void *_this, list_iterator_base *position, size_t n, void *data_ptr);

    /**
     * @brief insert n right_value element ahead of a givem position
     *
     */
    void (*insert_range_const)(void *_this, list_iterator_base *position, size_t n, ...);
     ...
     *
     */
    void (*insert_iterator)(void *_this, list_iterator_base *position, void *_begin, void *_end);
     ...
     *
     */
    void (*erase_range)(void *_this, list_iterator_base *begin, list_iterator_base *end);
